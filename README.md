...
The model uses **Input Attention Mechanism**, which solves the blurriness problem common in standard U-Nets. This is referenced from CircuitNet's official tutorial.
